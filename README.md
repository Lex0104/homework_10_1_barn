...
ДЗ №13_1
1. В задании были добавлены два источника финансовых транзакций csv и xlxs. 
2. Была установлена библиотека pandas
3. А так же реализован процесс считывания финансовых операций из CSV- и XLSX-файлов.
...
ДЗ №13_1
1. Создан модуль transactions_csv_excel.py, в модуле были представлены две функции transactions_csv и transactions_xlsx,
которые считывают данные с файлов transactions.csv и transactions_excel.xlsx - добавленные в директорию data
2. Были добавлен модуль test_transactions_csv_excel.py в пакет src
